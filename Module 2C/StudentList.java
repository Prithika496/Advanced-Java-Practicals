...
public class StudentList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<br>");
            out.println("<h3 align=center>Students</h3>");
            out.println("<table border=1px solid black align=center>");
            out.println("<tr>");
            out.println("<th>SAP ID</td>");
            out.println("<th>Name</td>");
            out.println("</tr>");
            
            out.println("<tr>");
            out.println("<td>809</td>");
            out.println("<td>Tanvi</td>");
            out.println("</tr>");
            
            out.println("<tr>");
            out.println("<td>112</td>");
            out.println("<td>Isha</td>");
            out.println("</tr>");
            out.println("</table>");
            out.println("<br>");
            ...
            out.println("<br>");
            out.println("<a href=SubjectList> <button> Subject </button> </a><br>");
            out.println("<br>");
